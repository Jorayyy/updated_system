...
class DtrApprovalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Only show records up to today to prevent approving "future" days
        ...
        return view('dtr-approval.index', compact('dtrs', 'payrollPeriods', 'employees', 'campaigns', 'accounts', 'stats'));
    }
