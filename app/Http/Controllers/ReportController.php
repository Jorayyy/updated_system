...
class ReportController extends Controller
{
    ...
    public function attendance(Request $request)
    {
        ...
        return view('reports.attendance', compact('summary', 'startDate', 'endDate', 'campaignId', 'campaigns'));
    }
    ...
    public function employees(Request $request)
    {
        ...
        $employees = $query->with(['campaign', 'account'])->orderBy('name')->paginate(25);
        $campaigns = \App\Models\Campaign::orderBy('name')->get();

        return view('reports.employees', compact('employees', 'campaigns', 'campaignId', 'status'));
    }
    ...
    public function exportEmployeesCsv(Request $request)
    {
        ...
        $callback = function() use ($employees) {
            ...
            fputcsv($file, [
                'Employee ID', 'Name', 'Email', 'Access Level', 'Campaign', 'Job Role',
            ...
            foreach ($employees as $employee) {
                fputcsv($file, [
                    ...
                    $employee->email,
                    $employee->role,
                    $employee->campaign?->name ?? 'N/A',
                    $employee->account?->name ?? 'N/A',
