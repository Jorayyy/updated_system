...
class PayrollController extends Controller
{
    ...
    {
        $query = PayrollPeriod::with(['processor', 'site', 'account', 'campaign'])
            ->withCount('payrolls');
        ...
        $stats = [
            ...
            'total_amount' => Payroll::whereHas('payrollPeriod', function($q) use ($request) {
                if ($request->filled('year')) {
        ...
        return view('payroll.periods', compact('periods', 'stats', 'sites', 'accounts', 'campaigns'));
    }
    ...
    public function createPeriod()
    {
        ...
        $accounts = Account::all();
        $campaigns = Campaign::all();
        return view('payroll.create-period', compact('sites', 'accounts', 'campaigns'));
    }
