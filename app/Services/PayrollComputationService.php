...
class PayrollComputationService
{
     ...
     */
    /**
     * Get summary statistics for a payroll period with optional filtering
     */
    public function getPeriodSummary(PayrollPeriod $period, array $filters = []): array
    {
        ...
        return [
            ...
            'total_gross' => $payrolls->sum('gross_pay'), // Unified with controller expected key
            'total_net' => $payrolls->sum('net_pay'), // Unified with controller expected key
