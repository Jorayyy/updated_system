...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/attendance/weekend-duty', [AttendanceController::class, 'recordWeekendDuty'])->name('attendance.weekend-duty');
    ...
    Route::middleware('hr')->group(function () {
        // Sites, Campaigns, Designations & Accounts Management
        ...
        Route::post('/employees/bulk-assign-campaign', [EmployeeController::class, 'bulkAssignCampaign'])->name('employees.bulk-assign-campaign');
        Route::post('/employees/bulk-assign-designation', [EmployeeController::class, 'bulkAssignDesignation'])->name('employees.bulk-assign-designation');
        ...
        Route::prefix('dtr-approval')->name('dtr-approval.')->group(function () {
            ...
            Route::post('/generate', [DtrApprovalController::class, 'generateDtrs'])->middleware('role:accounting,super_admin')->name('generate');
        });
        ...
        // Accounting Dashboard & Specific Features
        Route::prefix('accounting')->name('accounting.')->middleware('role:accounting,super_admin')->group(function () {
            Route::get('/salaries', [AccountingController::class, 'salaryIndex'])->name('salaries.index');
            Route::get('/salaries/{user}/edit', [AccountingController::class, 'salaryEdit'])->name('salaries.edit');
            Route::put('/salaries/{user}', [AccountingController::class, 'salaryUpdate'])->name('salaries.update');
            Route::get('/adjustments', [AccountingController::class, 'showBulkAdjustment'])->name('adjustments.index');
            Route::post('/adjustments', [AccountingController::class, 'storeAdjustment'])->name('adjustments.store');
            Route::post('/adjustments/upload', [AccountingController::class, 'uploadBulkAdjustment'])->name('adjustments.upload');
            Route::delete('/adjustments/{id}/type/{type}', [AccountingController::class, 'deleteAdjustment'])->name('adjustments.destroy');
        });
    });
