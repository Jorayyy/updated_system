                        ...
                        @foreach($leaveBalances as $balance)
                            <div class="border border-gray-200 rounded-lg p-4 bg-white transition-colors duration-200">
                                ...
                                <div class="flex items-baseline gap-2">
                                    <span class="text-2xl font-bold text-indigo-600">{{ $balance->remaining_days }}</span>
                                    <span class="text-sm text-gray-400">/ {{ $balance->allocated_days }} days</span>
                                </div>
                                <div class="text-xs text-gray-400 mt-1">Used: {{ $balance->used_days }} | Allocated: {{ $balance->allocated_days }}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
