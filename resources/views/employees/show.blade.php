                    ...
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="flex-grow grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="space-y-3">
                                    <div>
                                        <p class="text-xs text-gray-500 uppercase">Campaign</p>
                                        <p class="font-medium text-gray-900">{{ $employee->campaign?->name ?? 'N/A' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 uppercase">Job Role / Designation</p>
