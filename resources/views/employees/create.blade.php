                ...
                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('employees.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-10 flex flex-col items-center">
                            <div class="relative group">
                                <div class="w-32 h-32 rounded-full overflow-hidden bg-slate-100 border-4 border-indigo-50 shadow-lg">
                                    <img id="preview" src="https://ui-avatars.com/api/?name=New+Employee&background=6366f1&color=fff&size=128" 
                        ...
                        <div class="mb-12">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name_extension" value="{{ old('name_extension') }}" placeholder="e.g. Jr."
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <select name="payroll_group_id" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        @foreach($payrollGroups as $group)
                                            <option value="{{ $group->id }}" {{ old('payroll_group_id') == $group->id ? 'selected' : '' }}>{{ $group->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="report_to" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        @foreach($employees as $sup)
                                            <option value="{{ $sup->id }}" {{ old('report_to') == $sup->id ? 'selected' : '' }}>{{ $sup->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div class="md:col-span-1">
                                    ...
                                    <select name="role" required class="w-full border-indigo-200 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-white">
                                        ...
                                        <option value="hr" {{ old('role') == 'hr' ? 'selected' : '' }}>HR (Personnel Mgmt)</option>
                                        <option value="accounting" {{ old('role') == 'accounting' ? 'selected' : '' }}>Accounting (Payroll)</option>
                                ...
                                <div>
                                    <!-- Empty space to align pass fields below -->
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 uppercase mb-1">Password *</label>
                                    <input type="password" name="password" required
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-white">
                                    @error('password')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 uppercase mb-1">Confirm Password *</label>
                        ...
                        <div class="mb-12">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="bank" value="{{ old('bank') }}" placeholder="e.g. BDO, BPI"
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="tin" value="{{ old('tin') }}" placeholder="000-000-000-000"
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                        ...
                        <div class="mb-12">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="mobile_no_1" value="{{ old('mobile_no_1') }}"
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 uppercase mb-1">Mobile No. 2</label>
                                    <input type="text" name="mobile_no_2" value="{{ old('mobile_no_2') }}"
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="facebook" value="{{ old('facebook') }}" placeholder="URL or Username"
                                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-12">
                            ...
                            <div>
                                <textarea name="other_info" rows="3" placeholder="Any additional notes or information about this employee..."
                                    class="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('other_info') }}</textarea>
                            </div>
                        </div>
