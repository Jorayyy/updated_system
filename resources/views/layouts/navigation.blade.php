        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('leaves.index')" :active="request()->routeIs('leaves.index', 'leaves.create', 'leaves.show')">
                        {{ __('Leave') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                <!-- Dark Mode Toggle -->
                <button @click="darkMode = !darkMode" class="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->isAdmin() || auth()->user()->isHr())
                <div class="border-t border-gray-200 dark:border-gray-600 pt-2">
                    <div class="px-4 text-xs text-gray-500 dark:text-gray-400 uppercase">HR Management</div>
                </div>
