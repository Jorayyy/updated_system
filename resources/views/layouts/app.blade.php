                    ...
                    <div class="flex items-center gap-3 overflow-hidden">
                        <a x-show="sidebarOpen" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-x-4" x-transition:enter-end="opacity-100 translate-x-0" href="{{ route('dashboard') }}" class="flex items-center gap-3">
                            ...
                            <div class="flex flex-col sidebar-text sidebar-text-visible truncate">
                                ...
                                <span class="text-xs font-black uppercase tracking-[0.1em] transition-colors duration-300"
                    ...
                    <div x-data="{ userMenuOpen: false }" class="relative">
                        <button @click="userMenuOpen = !userMenuOpen" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-300 hover:bg-white/10 hover:text-white transition-all duration-200 group border border-transparent hover:border-gray-600/50">
                            ...
                            <div x-show="sidebarOpen" x-cloak class="flex-1 text-left min-w-0 sidebar-text" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">
                                <p class="text-sm font-bold text-white truncate group-hover:text-blue-200 transition-colors">{{ auth()->user()->name }}</p>
                                <p class="text-[11px] uppercase tracking-wider text-gray-400 font-black">{{ auth()->user()->role }}</p>
                            </div>
                ...
                <nav id="sidebar-nav" class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                    ...
                    <div class="relative nav-item mb-1">
                        <a href="{{ route('dashboard') }}" 
                           ...
                           :class="portalView === 'management' ? '{{ request()->routeIs('dashboard') ? 'bg-blue-600' : '' }}' : '{{ request()->routeIs('dashboard') ? 'bg-emerald-600' : '' }}'">
                            ...
                            <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Dashboard</span>
                        </a>
                    ...
                    <div x-show="portalView === 'personal'" x-cloak>
                        <div class="pt-4 mt-4 border-t border-gray-700/50">
                            <p x-show="sidebarOpen" x-cloak class="px-3 text-xs font-black text-emerald-400 uppercase tracking-widest mb-3 sidebar-text select-none" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">EMPLOYEE SERVICES</p>
                        </div>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('notifications.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('notifications.*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Notifications</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('attendance.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('attendance.*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Time Clock</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('dtr.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('dtr.*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">My DTR</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('payslip.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('payslip.*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">My Payslips</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('transactions.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('transactions.*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">My Transactions</span>
                            </a>
                        ...
                        <!-- My Concerns -->
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('concerns.my') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('concerns.my') || request()->routeIs('concerns.user-*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                <div class="w-8 h-8 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110">
                                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/>
                                    </svg>
                                </div>
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">My Concerns</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('announcements.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('announcements.*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Announcements</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('overtime-requests.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('overtime-requests.*') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Overtime Request</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('leaves.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('leaves.index') ? 'bg-emerald-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">My Leaves</span>
                            </a>
                    ...
                    @if(auth()->user()->isAdmin() || auth()->user()->isHr() || auth()->user()->isAccounting())
                        ...
                        <div class="pt-4 mt-4 border-t border-gray-700/50">
                            <p x-show="sidebarOpen" x-cloak class="px-3 text-xs font-black text-blue-400 uppercase tracking-widest mb-3 sidebar-text select-none" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">HR Management</p>
                        </div>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('sites.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('sites.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Sites</span>
                            </a>
                        ...
                        <!-- Departments -->
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('departments.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('departments.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                <div class="w-8 h-8 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110">
                                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                    </svg>
                                </div>
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Departments</span>
                            </a>
                            <div x-show="!sidebarOpen" class="tooltip">Departments</div>
                        </div>

                        <!-- Announcements Management -->
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('announcements.index', ['manage' => 1]) }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('announcements.*') && request('manage') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                <div class="w-8 h-8 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110">
                                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/>
                                    </svg>
                                </div>
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Broadcasts</span>
                            </a>
                            <div x-show="!sidebarOpen" class="tooltip">Manage Broadcasts</div>
                        </div>

                        <!-- Campaigns (Accounts) -->
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('accounts.index', ['type' => 'campaign']) }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('accounts.*') && request('type') == 'campaign' ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                <div class="w-8 h-8 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110">
                                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                </div>
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Campaigns</span>
                            </a>
                            <div x-show="!sidebarOpen" class="tooltip">Campaigns (Accounts)</div>
                        </div>

                        <!-- Payroll Groups -->
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('payroll-groups.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('payroll-groups.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                <div class="w-8 h-8 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110">
                                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                                    </svg>
                                </div>
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Groups</span>
                            </a>
                            <div x-show="!sidebarOpen" class="tooltip">Groups</div>
                        </div>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('schedules.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('schedules.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Schedules</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('employees.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('employees.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Employees</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('attendance.manage') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('attendance.manage', 'attendance.create', 'attendance.edit', 'attendance.show') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Attendance Records</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('dtr-approval.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('dtr-approval.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">DTR Center</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('timekeeping.admin-index', ['tab' => 'logs']) }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ (request()->routeIs('timekeeping.admin-index') && (request('tab', 'logs') === 'logs')) ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Timekeeping Mgmt</span>
                            </a>
                        ...
                        <div class="pt-4 mt-4 border-t border-gray-700/50">
                            <p x-show="sidebarOpen" x-cloak class="px-3 text-xs font-black text-blue-400 uppercase tracking-widest mb-3 sidebar-text select-none" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Tools & Reports</p>
                        </div>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('holidays.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('holidays.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Holidays</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('reports.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('reports.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Reports</span>
                            </a>
                        ...
                        <div class="relative nav-item mb-1">
                            <a href="{{ route('audit-logs.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('audit-logs.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                ...
                                <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Audit Logs</span>
                            </a>
                            ...
                            <!-- Admin Section -->
                            <div class="pt-4 mt-4 border-t border-gray-700/50">
                                <p x-show="sidebarOpen" x-cloak class="px-3 text-xs font-black text-blue-400 uppercase tracking-widest mb-3 sidebar-text select-none" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Administration</p>
                            </div>

                            <!-- User Roles -->
                            <div class="relative nav-item mb-1">
                                <a href="{{ route('accounts.index', ['type' => 'role']) }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('accounts.*') && request('type') == 'role' ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                    <div class="w-8 h-8 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110">
                                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                                        </svg>
                                    </div>
                                    <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">User Roles</span>
                                </a>
                                <div x-show="!sidebarOpen" class="tooltip">User Roles (Permissions)</div>
                            </div>
                            ...
                            <div class="relative nav-item mb-1">
                                <a href="{{ route('settings.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('settings.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                    ...
                                    <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Settings</span>
                                </a>
                            ...
                            <div class="relative nav-item mb-1">
                                <a href="{{ route('backups.index') }}" class="flex items-center gap-3 px-3 py-2.5 mx-2 rounded-xl transition-all duration-200 group {{ request()->routeIs('backups.*') ? 'bg-blue-600 text-white shadow-lg ring-1 ring-white/20' : 'text-gray-400 hover:bg-white/5 hover:text-white' }}">
                                    ...
                                    <span x-show="sidebarOpen" x-cloak class="sidebar-text font-black text-[15px] uppercase tracking-wide" :class="sidebarOpen ? 'sidebar-text-visible' : 'sidebar-text-hidden'">Backups</span>
                                </a>
