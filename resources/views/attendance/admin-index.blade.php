                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Campaign/Role</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($attendances as $attendance)
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap">
                                            <div class="text-xs font-bold text-blue-600 uppercase">{{ $attendance->user->campaign->name ?? '-' }}</div>
                                            <div class="text-[10px] text-green-600 font-bold uppercase">{{ $attendance->user->designation->name ?? '-' }}</div>
                                        </td>
