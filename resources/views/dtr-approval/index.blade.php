    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm mb-8 overflow-hidden">
        ...
        <div class="p-6">
            <form method="GET" action="{{ route('dtr-approval.index') }}" id="filterForm" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div class="space-y-1">
                    <label class="block text-xs font-bold text-blue-600 uppercase">Campaign</label>
                    <select name="campaign_id" class="w-full rounded-lg border-gray-200 text-sm focus:border-blue-500 focus:ring-blue-500 font-bold text-blue-600 uppercase" onchange="this.form.submit()">
                ...
                <div class="space-y-1">
                    <label class="block text-xs font-medium text-gray-400 uppercase italic">Role</label>
                    <select name="account_id" class="w-full rounded-lg border-gray-200 text-sm focus:border-gray-500 focus:ring-gray-500 italic text-gray-400" onchange="this.form.submit()">
