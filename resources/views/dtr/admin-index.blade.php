                ...
                <div class="p-4">
                    <form action="{{ route('dtr.bulk-pdf') }}" method="POST" id="bulk-form">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 disabled:opacity-50" id="bulk-download">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($dtrData as $item)
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">{{ $item['employee']->employee_id }}</td>
                                        <td class="px-4 py-3 whitespace-nowrap text-sm">{{ $item['employee']->name }}</td>
