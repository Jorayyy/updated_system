            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6 transition-colors duration-200">
                <div class="p-6">
                    <form method="GET" class="flex flex-wrap items-center gap-4">
                        ...
                        <div>
                            <select name="account_id" class="border-gray-300 rounded-md shadow-sm text-sm italic text-gray-400">
                                ...
                                @forelse($dtrData as $item)
                                    <tr class="transition-colors duration-200">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="text-xs font-bold text-blue-600 uppercase">{{ $item['employee']->campaign->name ?? '-' }}</div>
                                            <div class="text-[10px] text-gray-500 italic">{{ $item['employee']->designation->name ?? '-' }}</div>
                                        </td>
