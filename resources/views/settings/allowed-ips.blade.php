            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4">Add Allowed IP</h3>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-blue-700">Your Current IP:</span>
                                </div>
                                <p class="text-lg font-mono font-semibold text-blue-800 mt-1">{{ $currentIp }}</p>
                                ...
                                @else
                                    <span class="text-sm text-green-600">✓ Already allowed</span>
                                @endif
                            </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-4">
                                <h3 class="text-lg font-semibold text-gray-900">Allowed IP Addresses</h3>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Label / Location</th>
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        @forelse($allowedIps as $ip)
                                            <tr class="{{ !$ip->is_active ? 'opacity-50' : '' }}">
                                                ...
                                                <td class="px-4 py-3">
                                                    <div class="text-sm font-medium text-gray-900">{{ $ip->label }}</div>
                                                    @if($ip->location)
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap text-center">
                                                    <form action="{{ route('settings.allowed-ips.toggle', $ip) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="px-3 py-1 text-xs rounded-full transition {{ $ip->is_active ? 'bg-green-100 text-green-800 hover:bg-green-200' : 'bg-gray-100 text-gray-800 hover:bg-gray-200' }}">
