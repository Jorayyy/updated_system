                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2 flex items-center gap-6">
                                    <div class="w-20 h-20 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center border-2 border-gray-200">
                                        @if(isset($settings['company_logo']) && $settings['company_logo'])
                                            <img src="{{ asset('storage/' . $settings['company_logo']) }}" alt="Company Logo" class="max-w-full max-h-full object-contain">
                                        @else
                                            <div class="text-xs text-gray-400 font-bold uppercase text-center px-1">No Logo</div>
                                        @endif
                                    </div>
                                    <div class="flex-1">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">PNG, JPG, or SVG. Max 1MB. Recommended size: 200x200px.</p>
                                    </div>
                                </div>
