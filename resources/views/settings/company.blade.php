                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2 flex items-center gap-4">
                                    ...
                                    @endif
                                    <div class="flex-1">
                                        <input type="file" name="company_logo" id="company_logo" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                                        <p class="mt-1 text-xs text-gray-500">Recommended size: 512x512px. Max: 2MB.</p>
                                    </div>
                                </div>
