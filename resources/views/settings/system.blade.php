            ...
            <form action="{{ route('settings.system.update') }}" method="POST">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Configure timezone and locale preferences</p>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">System Timezone</label>
                                <select name="system_timezone" class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500">
                            ...
                            <div>
                                ...
                                <select name="system_currency" class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Configure how dates and times are displayed</p>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Date Format</label>
                                <select name="date_format" class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500">
                            ...
                            <div>
                                ...
                                <select name="time_format" class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500">
                        ...
                        <div class="mt-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Week Start Day</label>
                            <select name="week_start_day" class="w-full md:w-1/2 rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Configure security and session settings</p>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Session Timeout (minutes)</label>
                                <input type="number" name="session_timeout_minutes" step="5" min="5" max="480" value="{{ $settings['session_timeout_minutes'] ?? 120 }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500">
                                <p class="text-xs text-gray-500 mt-1">Idle time before automatic logout</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Max Login Attempts</label>
                                <input type="number" name="max_login_attempts" step="1" min="3" max="10" value="{{ $settings['max_login_attempts'] ?? 5 }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Configure data retention and backup settings</p>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="maintenance_mode" value="1" {{ ($settings['maintenance_mode'] ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-yellow-600 shadow-sm focus:ring-yellow-500">
                                <span class="ml-2 text-sm font-medium text-gray-700">Enable Maintenance Mode</span>
                            </label>
                            <div class="ml-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="ml-4 px-6 py-2 bg-gray-700 text-white text-sm font-medium rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                        Save Settings
                    </button>
                </div>
            </form>
