        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900 dark:text-gray-100">{{ $employee->department ?? '-' }}</p>
                        </div>
                        <div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('leave-credits.update', $employee->id) }}" method="POST">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Leave Credits Allocation</h3>
                                    ...
                                    <div class="flex flex-wrap items-center gap-4">
                                        ...
                                        <div class="flex items-center gap-6">
                                            <div class="text-center">
                                                <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Allocated</label>
                                                <input type="number" name="credits[{{ $index }}][allocated_days]" 
                                                    ...
                                                    class="w-24 text-center border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded-md shadow-sm">
                                            </div>
                                            
                                            @if($balance)
                                                <div class="text-center">
                                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Used</label>
                                                    <div class="w-24 py-2 text-center text-red-600 font-medium">
                                                        {{ $balance->used_days }}
                                                    </div>
                                                </div>
                                                <div class="text-center">
                                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Remaining</label>
