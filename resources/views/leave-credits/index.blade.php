                ...
                <div class="p-6">
                    <div class="flex flex-wrap gap-4 items-end justify-between">
                        ...
                        <div class="flex gap-2">
                            ...
                            @else
                                <button type="button" @click="addNotification('error', 'Access Denied: Only Super Admins have the authority to manage leave credits.')"
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                @else
                                                    <button type="button" 
                                                        @click="addNotification('error', 'Access Denied: Only Super Admins have the authority to edit leave credits.')"
                                                        class="text-gray-400 cursor-not-allowed" title="Edit Credits">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                        </svg>
                                                    </button>
                                                    <button type="button" 
                                                        @click="addNotification('error', 'Access Denied: Only Super Admins have the authority to adjust leave credits.')"
                                                        class="text-gray-400 cursor-not-allowed" title="Quick Adjust">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"></path>
                                                        </svg>
                                                    </button>
