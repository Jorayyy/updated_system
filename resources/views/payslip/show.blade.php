<x-app-layout>
    ...
    <div class="py-2 bg-slate-100 min-h-screen font-sans text-[10px]">
        ...
        <div class="max-w-[1100px] mx-auto px-2 no-print mb-2">
            <div class="flex items-center justify-between gap-2">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <h2 class="text-base font-black text-slate-900 leading-tight">Payslip</h2>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('payslip.download', $payroll) }}" class="inline-flex items-center px-4 py-1.5 bg-indigo-600 text-white text-[9px] font-black uppercase rounded shadow-sm hover:bg-indigo-700 transition tracking-widest">
                        Full PDF
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-[1100px] mx-auto bg-white border border-slate-800 shadow-lg print-container overflow-hidden">
            <!-- HEADER STRIPE -->
