<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endphp
            {{-- Filters --}}
            <div class="bg-white overflow-hidden shadow-sm rounded-lg mb-6 p-4 border border-gray-100">
                <form method="GET" class="flex flex-wrap items-center gap-4">
                    <div class="flex-1 min-w-[200px]">
                        <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Campaign Filter</label>
                        <select name="campaign_id" onchange="this.form.submit()" class="w-full border-gray-300 rounded-md shadow-sm text-sm font-bold text-blue-600">
                    ...
                    <div class="flex-1 min-w-[200px]">
                        <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Role Filter</label>
                        <select name="account_id" onchange="this.form.submit()" class="w-full border-gray-300 rounded-md shadow-sm text-sm italic text-gray-500">
                    ...
                    <div class="flex items-end">
                        <a href="{{ route('payroll.computation.show', $period) }}" class="text-sm text-gray-500 hover:text-gray-700 underline">Reset Filters</a>
                    </div>
                </form>
            </div>
                                        ...
                                        <div class="flex items-center">
                                            <div>
                                                ...
                                                <div class="flex flex-col">
                                                    <span class="text-[10px] text-blue-600 font-bold uppercase">{{ $payroll->user->campaign?->name ?? 'N/A' }}</span>
                                                    <span class="text-[10px] text-gray-500 italic">{{ $payroll->user->account?->name ?? 'N/A' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
