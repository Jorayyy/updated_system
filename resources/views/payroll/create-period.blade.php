            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('payroll.store-period') }}">
                        ...
                        <div class="space-y-6">
                            <!-- Site, Campaign and Role Selection -->
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50 p-4 rounded-lg">
                                <div>
                                    <x-input-label for="site_id" :value="__('Limit to Site')" />
                                ...
                                <div>
                                    <x-input-label for="campaign_id" :value="__('Limit to Campaign')" class="text-blue-600 font-bold" />
                                    <select name="campaign_id" id="campaign_id" 
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 font-bold">
                                ...
                                <div>
                                    <x-input-label for="account_id" :value="__('Limit to System Role')" class="text-gray-400 italic" />
                                    <select name="account_id" id="account_id" 
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-gray-400">
