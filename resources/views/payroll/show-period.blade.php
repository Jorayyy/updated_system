        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    {{ $period->name }}
                    @if($period->site) <span class="text-indigo-600">({{ $period->site->name }})</span> @endif
                    @if($period->designation) <span class="text-emerald-600">[{{ $period->designation->name }}]</span> @endif
                </h2>
