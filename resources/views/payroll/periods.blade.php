                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div class="flex flex-col items-center space-y-2">
                                                ...
                                                <a href="{{ route('payroll.show-period', $period) }}" class="text-yellow-500 hover:text-yellow-600" title="Manage/View Period">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                                                    </svg>
                                                </a>

                                                <form action="{{ route('payroll.destroy-period', $period) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this payroll period? This will delete all associated payroll records.');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-pink-600 hover:text-pink-800" title="Delete Period">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
