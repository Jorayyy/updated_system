            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" class="flex flex-wrap items-center gap-4">
                        ...
                        <select name="campaign_id" class="border-gray-300 rounded-md shadow-sm font-bold text-blue-600">
                        ...
                        <select name="account_id" class="border-gray-300 rounded-md shadow-sm italic text-gray-500">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Period / Site / Account</th>
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                {{ ucfirst($period->period_type ?? $period->type) }} 
                                                @if($period->site) | {{ $period->site->name }} @endif
                                                @if($period->campaign) | <b class="text-blue-600">{{ $period->campaign->name }}</b> @endif
                                                @if($period->designation) | <span class="italic text-gray-400">{{ $period->designation->name }}</span> @endif
                                            </div>
                                        </td>
