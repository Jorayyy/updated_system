                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('payroll.index') }}" class="flex flex-wrap gap-4 items-end">
                        ...
                        <div>
                            ...
                            <a href="{{ route('payroll.index') }}" class="ml-2 text-gray-600 hover:text-gray-800 transition-colors duration-200">Clear</a>
                        </div>
                    </form>
                </div>
            </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div>
                                                ...
                                                <div class="text-xs font-bold text-green-600 uppercase">{{ $payroll->user->designation?->name ?? 'N/A' }}</div>
