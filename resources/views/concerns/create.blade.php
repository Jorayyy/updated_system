            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('concerns.store') }}" method="POST" class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div id="date_affected_container" class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-50 rounded-xl border border-gray-200" style="{{ old('category') == 'timekeeping' ? '' : 'display: none;' }}">
                            <div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs text-gray-600">
                                ...
                                <div><strong>Timekeeping:</strong> Log errors, punch issues</div>
