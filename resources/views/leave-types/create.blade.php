                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" 
                                    :value="old('name')" required placeholder="e.g., Vacation Leave" />
                            ...
                            <div>
                                ...
                                <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" 
                                    :value="old('code')" required placeholder="e.g., VL" maxlength="10" />
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3"
                                    ...
                                    placeholder="Brief description of this leave type...">{{ old('description') }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="max_days" name="max_days" type="number" class="mt-1 block w-full" 
                                    :value="old('max_days', 5)" required min="0" max="365" />
