<x-app-layout>
        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    ...
                    <div class="text-sm text-gray-500">Logged In Today</div>
                </div>
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="text-2xl font-bold text-yellow-600">{{ $stats['on_break'] }}</div>
                    <div class="text-sm text-gray-500">Currently On Break</div>
                </div>
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="text-2xl font-bold text-purple-600">{{ $stats['in_meeting'] }}</div>
                    <div class="text-sm text-gray-500">In Meeting</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4">Add Transaction</h3>
                            ...
                            <form action="{{ route('timekeeping.admin-store') }}" method="POST">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <select name="user_id" required class="w-full rounded-md border-gray-300 shadow-sm text-sm">
                                    ...
                                    <div>
                                        ...
                                        <select name="transaction_type" required class="w-full rounded-md border-gray-300 shadow-sm text-sm">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="notes" rows="2" class="w-full rounded-md border-gray-300 shadow-sm text-sm"></textarea>
                                    </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form method="GET" class="flex flex-wrap items-center gap-3 mb-4">
                                ...
                                <a href="{{ route('timekeeping.admin-index') }}" class="text-gray-500 hover:text-gray-700 text-sm">Clear</a>
                            </form>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        @forelse($transactions as $transaction)
                                            <tr class="{{ $transaction->isVoided() ? 'opacity-50 bg-red-50' : '' }}">
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                                    ...
                                                    <div class="text-xs text-gray-500">{{ $transaction->transaction_time->format('h:i:s A') }}</div>
                                                </td>
                                                <td class="px-4 py-3 whitespace-nowrap">
    ...
    <div id="void-modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Void Transaction</h3>
