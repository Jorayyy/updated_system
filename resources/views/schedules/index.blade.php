                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Campaign / Role</th>
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-bold">
                                            @if($schedule->campaign)
                                                <span class="text-blue-600">{{ $schedule->campaign->name }}</span>
                                            @endif
                                            @if($schedule->designation)
                                                <span class="text-xs text-green-600 block italic font-bold uppercase">{{ $schedule->designation->name }}</span>
                                            @endif
                                        </td>
