...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        ...
        <h2 class="text-3xl font-semibold text-gray-800 mb-4">Server Error</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button onclick="location.reload()" class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
