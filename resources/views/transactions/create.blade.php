                ...
                <div class="p-6">
                    <form action="{{ route('transactions.store', $type) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            @if($type === 'leave')
                                <div>
                                    <label for="leave_type_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            @if($type === 'leave_cancellation')
                                <div>
                                    <label for="original_transaction_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    @if($approvedLeaves->isEmpty())
                                        <p class="mt-1 text-sm text-yellow-600 dark:text-yellow-400">No approved future leaves found to cancel.</p>
                                    @endif
                            ...
                            @if($type === 'payroll_complaint')
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="payroll_period" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div>
                                        <label for="complaint_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            @if($type === 'schedule_change' || $type === 'restday_change')
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="current_schedule" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div>
                                        <label for="requested_schedule" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            @if($type === 'undertime')
                                <div>
                                    <label for="undertime_type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            @if($type === 'timekeeping_complaint')
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label for="expected_time" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            @if($typeInfo['requires_dates'] ?? false)
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    @if($type !== 'leave_cancellation' && $type !== 'timekeeping_complaint')
                                        <div>
                                            <label for="effective_date_end" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            @if($typeInfo['requires_time'] ?? false)
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label for="time_from" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Time From
                                        </label>
                                    ...
                                    <div>
                                        <label for="time_to" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Time To
                                        </label>
                            ...
                            <div>
                                ...
                                <textarea name="reason" id="reason" rows="4" required
                                          ...
                                          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm">{{ old('reason') }}</textarea>
                                @error('reason')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
