...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $settings = [
            ['key' => 'company_name', 'value' => 'MEBS Call Center', 'type' => 'string'],
            ['key' => 'company_address', 'value' => 'Tacloban City, Leyte, Philippines', 'type' => 'string'],
            ['key' => 'work_start_time', 'value' => '08:00', 'type' => 'string'],
            ['key' => 'work_end_time', 'value' => '17:00', 'type' => 'string'],
            ['key' => 'grace_period_minutes', 'value' => '15', 'type' => 'integer'],
            ['key' => 'regular_work_hours', 'value' => '8', 'type' => 'integer'],
            ['key' => 'lunch_break_minutes', 'value' => '60', 'type' => 'integer'],
            ['key' => 'overtime_rate_multiplier', 'value' => '1.25', 'type' => 'float'],
            ['key' => 'holiday_rate_multiplier', 'value' => '2.0', 'type' => 'float'],
            ['key' => 'night_diff_rate', 'value' => '0.10', 'type' => 'float'],
            ['key' => 'sss_employer_share', 'value' => '0.095', 'type' => 'float'],
            ['key' => 'philhealth_employer_share', 'value' => '0.025', 'type' => 'float'],
            ['key' => 'pagibig_employer_share', 'value' => '100', 'type' => 'float'],
        ];
